...
<div class="container">
    ...
    <div class="information">
        ...
        <div class="textcontent col-lg-6 col-lg-offset-3" style="height: 1500px">
                ...
                <form id="form1">
                    <div class="form-group">
                        ...
                        <button id="autofill" type="button" onclick="act()"class="btn btn-primary btn-sm" disabled>Auto Fill</button>
                ...
                <form id="form3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="author" placeholder="Input the Author of the book" name="author">
                ...
                <form id="form4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="publisher" placeholder="Input the Publisher of the book" name="publisher">
                ...
                <form id="form5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="shelflocation" placeholder="Input the Shelf Location of the book" name="shelflocation">
                ...
                <form id="form6">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="description" placeholder="Input the abstract or description......" rows="3"></textarea>
                    </div>
                </form>
                <form id="form7">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="price" placeholder="Input the Price of the book" name="price">
                        </div>
                ...
                <div style="text-align: center;height: auto">
                    <input class="btn btn-primary" type="button" onclick="window.location.href='AddBookOk.jsp'" value="Submit" disabled id="submit">
                </div>
